    ...
    for iteration in range(first_iter, opt.iterations + 1):        
        ...
        with torch.no_grad():
            ...
            if iteration < opt.iterations:
                ...
                # # --- ADD THIS BLOCK ---
                # with torch.no_grad():
                #     # 1. Flatten Z-direction (Log scale -7.0 is very thin)
                #     # Note: index 2 is usually Z. 
                #     gaussians._scaling[:, 2] = -7.0
                    
                #     # 3. High opacity (Logit 10.0 is ~0.9999 alpha)
                #     gaussians._opacity.fill_(10.0)
                # # ----------------------
